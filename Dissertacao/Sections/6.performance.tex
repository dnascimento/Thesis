...
\centering   
  \begin{tabular}{l|rr}     
           & \textbf{\# objects} & \textbf{size (bytes)} \\ \hline  
  Start    & 1          & 16           \\
  End      & 1          & 16           \\                        
  Before   & 1          & 61           \\     %   1 199 305 - 40 487 088 bytes for sample of 663 105 entries
  After    & 5          & 162          \\ \hline    % 153 356 416 -  3 527 873 bytes for sample of 663 105 entries
...
\centering
\begin{tabular}{l|rrr}
                  & \textbf{1 million}   & \textbf{20 million (day)}    & \textbf{2 billion (quarter)} \\ \hline
