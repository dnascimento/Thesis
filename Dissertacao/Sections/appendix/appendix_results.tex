...
\end{tabular}
  \caption[Recovery duration]{Recovery duration (request throughput between parenthesis). Duration and latency on first execution (request throughput and 95th percentile between parenthesis, respectively). %considering variable number of database and web-server instances.
  }
